...
% Euler's Method
for i = 1:N
    y_approx_array(i+1) = y_approx_array(i) + h * f(x_val_array(i), y_approx_array(i));
end
...
% Plot
figure;
plot(x_val_array, y_approx_array, '-o', 'LineWidth', 1.5, 'DisplayName', 'Euler method');
hold on;
...
legend;
grid on;
title('Euler''s Method vs. Actual Solution');
